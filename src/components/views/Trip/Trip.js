          ...
          <Row>
            <Col md={12} lg={4}>
              ...
              <List variant='light'>
                ...
                <div className={styles.promo}><ListItem title={`<strong>Price from:</strong> ${promoPrice(cost, 20)}`} icon='money-bill-wave' /></div>
        ...
        <Row>
          <Col>
            <div className={styles.wrapper}>
              <div className={styles.promo}>Price from: {promoPrice(cost, 20)}</div>
              <div>Standard price: from {cost}</div>
            </div>
          </Col>
        </Row>
      </Grid>
